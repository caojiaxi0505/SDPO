...
export TENSORBOARD_DIR=/cfs_turbo/jiaxicao/tensorboard/ucsdpo-tooluse-qwen3-8b-emajf-vllm-h20-resume-260528
export ROLLOUT_DIR=/cfs_turbo/jiaxicao/rollouts/ucsdpo-tooluse-qwen3-8b-emajf-vllm-h20-resume-260528
export TOKENIZERS_PARALLELISM=false
export CUDA_VISIBLE_DEVICES=0,1,2,3
bash training/verl_training.sh \
  ucsdpo-tooluse-qwen3-8b-emajf-vllm-h20-resume-260528 \
  sdpo \
  datasets/tooluse \
  ...
  trainer.resume_from_path=/cfs_turbo/jiaxicao/ckpt/ucsdpo_runs/ucsdpo-tooluse-qwen3-8b-emajf-vllm-h20-260527/global_step_630 \
  trainer.test_freq=5 \
  trainer.save_freq=50 \
  trainer.max_actor_ckpt_to_keep=20 \
  trainer.default_local_dir=/cfs_turbo/jiaxicao/ckpt/ucsdpo_runs/ucsdpo-tooluse-qwen3-8b-emajf-vllm-h20-resume-260528 \
  trainer.rollout_data_dir=${ROLLOUT_DIR}/train \
  trainer.validation_data_dir=${ROLLOUT_DIR}/val \
  'trainer.logger=["console","tensorboard"]' \
  2>&1 | tee /cfs_turbo/jiaxicao/logs/ucsdpo/ucsdpo-tooluse-qwen3-8b-emajf-vllm-h20-resume-260528.log
