...
export TENSORBOARD_DIR=/cfs_turbo/jiaxicao/tensorboard/sdpo-toolace-qwen3-8b-h20-260602
export ROLLOUT_DIR=/cfs_turbo/jiaxicao/rollouts/sdpo-toolace-qwen3-8b-h20-260602
export TOKENIZERS_PARALLELISM=false
export CUDA_VISIBLE_DEVICES=0,1,2,3
bash training/verl_training.sh \
  sdpo-toolace-qwen3-8b-h20-260602 \
  sdpo \
  datasets/toolace \
  ...
  trainer.default_local_dir=/cfs_turbo/jiaxicao/ckpt/ucsdpo_runs/sdpo-toolace-qwen3-8b-h20-260602 \
  trainer.rollout_data_dir=${ROLLOUT_DIR}/train \
  trainer.validation_data_dir=${ROLLOUT_DIR}/val \
  'trainer.logger=["console","tensorboard"]' \
  2>&1 | tee /cfs_turbo/jiaxicao/logs/ucsdpo/sdpo-toolace-qwen3-8b-h20-260602.log
