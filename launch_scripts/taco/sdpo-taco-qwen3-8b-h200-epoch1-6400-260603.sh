...
export TENSORBOARD_DIR=/mnt/fsx/youtu-agent/jiaxicao/tensorboard/sdpo-taco-qwen3-8b-h200-6400-260603
export ROLLOUT_DIR=/mnt/fsx/youtu-agent/jiaxicao/rollouts/sdpo-taco-qwen3-8b-h200-6400-260603
export TOKENIZERS_PARALLELISM=false
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export NCCL_SOCKET_IFNAME=eth0
export GLOO_SOCKET_IFNAME=eth0
bash training/verl_training.sh \
  sdpo-taco-qwen3-8b-h200-6400-260603 \
  sdpo \
  datasets/taco \
  ...
  trainer.default_local_dir=/mnt/fsx/youtu-agent/jiaxicao/ckpt/ucsdpo_runs/sdpo-taco-qwen3-8b-h200-6400-260603 \
  trainer.rollout_data_dir=${ROLLOUT_DIR}/train \
  trainer.validation_data_dir=${ROLLOUT_DIR}/val \
  'trainer.logger=["console","tensorboard"]' \
  2>&1 | tee /mnt/fsx/youtu-agent/jiaxicao/logs/ucsdpo/sdpo-taco-qwen3-8b-h200-6400-260603.log
