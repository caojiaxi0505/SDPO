...
export TENSORBOARD_DIR=/cfs_turbo/jiaxicao/tensorboard/grpo-ucsdpoaux-apigen-qwen3-8b-emajf-vllm-h20-260601
export ROLLOUT_DIR=/cfs_turbo/jiaxicao/rollouts/grpo-ucsdpoaux-apigen-qwen3-8b-emajf-vllm-h20-260601
export TOKENIZERS_PARALLELISM=false
export CUDA_VISIBLE_DEVICES=0,1,2,3
bash training/verl_training.sh \
  grpo-ucsdpoaux-apigen-qwen3-8b-emajf-vllm-h20-260601 \
  sdpo \
  datasets/apigen \
  ...
  trainer.default_local_dir=/cfs_turbo/jiaxicao/ckpt/ucsdpo_runs/grpo-ucsdpoaux-apigen-qwen3-8b-emajf-vllm-h20-260601 \
  trainer.rollout_data_dir=${ROLLOUT_DIR}/train \
  trainer.validation_data_dir=${ROLLOUT_DIR}/val \
  'trainer.logger=["console","tensorboard"]' \
  2>&1 | tee /cfs_turbo/jiaxicao/logs/ucsdpo/grpo-ucsdpoaux-apigen-qwen3-8b-emajf-vllm-h20-260601.log
