...
export TENSORBOARD_DIR=/mnt/fsx/youtu-agent/jiaxicao/tensorboard/grpo-ucsdpoaux-scienceqa-qwen3-8b-emajf-vllm-h200-260603
export ROLLOUT_DIR=/mnt/fsx/youtu-agent/jiaxicao/rollouts/grpo-ucsdpoaux-scienceqa-qwen3-8b-emajf-vllm-h200-260603
export TOKENIZERS_PARALLELISM=false
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export NCCL_SOCKET_IFNAME=eth0
export GLOO_SOCKET_IFNAME=eth0
bash training/verl_training.sh \
  grpo-ucsdpoaux-scienceqa-qwen3-8b-emajf-vllm-h200-260603 \
  sdpo \
  datasets/scienceqa \
  ...
  trainer.default_local_dir=/mnt/fsx/youtu-agent/jiaxicao/ckpt/ucsdpo_runs/grpo-ucsdpoaux-scienceqa-qwen3-8b-emajf-vllm-h200-260603 \
  trainer.rollout_data_dir=${ROLLOUT_DIR}/train \
  trainer.validation_data_dir=${ROLLOUT_DIR}/val \
  'trainer.logger=["console","tensorboard"]' \
  2>&1 | tee /mnt/fsx/youtu-agent/jiaxicao/logs/ucsdpo/grpo-ucsdpoaux-scienceqa-qwen3-8b-emajf-vllm-h200-260603.log
